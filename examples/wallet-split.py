...
result = frost.keys_split("c01a8db2b719feda0025eee7f74b0632c2d0ef9d44960cb806485abc043742d0", max_signers, min_signers)
...
for id, share in shares.items():
    ...
    key_packages[id] = {
        "header": share.header.model_dump(mode="python"),
    ...
    text = json.dumps(
        {
            ...
            "pubkeyPackage": pubkey_package.model_dump(mode="python"),
        },
        indent=4,
    )
    file.write(text)
